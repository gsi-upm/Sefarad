jQuery(document).ready(function($){
 ...
 //        data.push({name: $(this).attr('name'), value: $(this).attr('value')});
 //        // place spinner
 //        $div.html('<img src="./img/bot/spgray.gif" />');
 //        // send the data
 ...
 //        var default_src = "img/bot/avatars/duke.png";
 //        var img_map = {'saludo':'img/bot/avatars/duke_hello.png',
 //                       'despedida':'img/bot/avatars/duke_hello.png',  
 //                       'fallo1':'img/bot/avatars/duke_waiting.png',
 //                       'fallo2':'img/bot/avatars/duke_waiting.png',
 //                       'enfado':'img/bot/avatars/duke_waiting.png',
 //                       'espera':'img/bot/avatars/duke_thinking.png',
 //                       'acierto1':'img/bot/avatars/duke_ok.png',
 //                       'acierto2':'img/bot/avatars/duke_connect.png',
 //                       'acierto3':'img/bot/avatars/duke_connect.png',
 //                       'acierto4':'img/bot/avatars/duke_ok.png'};
 ...
 //        var img_set = ['img/bot/avatars/duke_hello.png', 
 //                       'img/bot/avatars/duke_waiting.png',
 //                       'img/bot/avatars/duke_connect.png',
 //                       'img/bot/avatars/duke_thinking.png',
 //                       'img/bot/avatars/duke_ok.png'];
