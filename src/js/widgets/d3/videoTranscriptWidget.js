...
var videoTranscriptWidget = {
  ...
  transcript: function (id) {
    $('#' + id).html('<style>#full-transcript{height:90px;overflow-y:auto;resize:vertical}#full-transcript p{color:black;display:inline;float:right;text-align:left;width:100%}</style><div id="full-transcript"><p></p></div>');
  }
};
