...
(function () {
    ...
    function filter() {
        ...
        //results var is a reference to a external variable to make possible watching results from the outside

        ////first: empty resultsVar
        //while (settings.resultsVar.length > 0) {
        //    settings.resultsVar.pop();
        //}
        //
        ////second: move currentResults into resultsVar
        //for (var i = 0, len = settings.currentResults.length; i < len; i++) {
        //    settings.resultsVar[i] = settings.currentResults[i];
        //}
        ...
        //second: move currentResults into resultsVar
        for (var i = 0, len = settings.currentResults.length; i < len; i++) {
            filteredData[i] = settings.currentResults[i];
        }
