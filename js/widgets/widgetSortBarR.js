...
var widgetSortBarR = {
		...
		render: function () {
			...
			var field = widgetSortBarR.field || "";
			vm.activeWidgetsRight.push({"id":ko.observable(id),"title": ko.observable(widgetSortBarR.name), "type": ko.observable(widgetSortBarR.type), "field": ko.observable(field),"collapsed": ko.observable(false)});
			
			// widgetSortBarR.paint(field, id, widgetSortBarR.type);
			widgetSortBarR.paint(id);
		},
