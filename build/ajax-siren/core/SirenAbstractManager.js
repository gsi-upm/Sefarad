// $Id$
// our own implementation with modified 
// doRequest and afterResponse
 ...
 */
AjaxSolr.SirenAbstractManager = AjaxSolr.Class.extend(
   ...
   */
  doRequest: function (start, servlet, widgetIds) {
    ...
    if(this.widgetIds !== undefined){
    	this.widgetIds = widgetIds;
    	for (var widgetId in this.widgets) {
  	      if( jQuery.inArray(widgetId,this.widgetIds) !== -1){
    		  this.widgets[widgetId].beforeRequest();
  	      }
    	}
    }else{
    	this.widgetIds = undefined;
    	for (var widgetId in this.widgets) {
    		this.widgets[widgetId].beforeRequest();
    	}
    }
