...
var widgetWheel = {
    ...
    paint: function(id) {
        ...
        $.each(vm.filteredData(), function(index, item) {
            ...
            var resultOne = $.grep(array, function(e) {
                return e["name"].valueOf() == location.valueOf();
            });
            ...
            var resultTwo = $.grep(one["children"], function(e) {
                return e["name"].valueOf() == polarity.valueOf();
            });
